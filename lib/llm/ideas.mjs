...
export async function generateLLMIdeas(provider, sweepData, delta, previousIdeas = []) {
  ...
  const cnFocus = config.marketFocus === 'cn' || config.marketFocus === 'china';
...
${cnFocus ? `
Regional focus:
- PRIORITIZE China A-shares, HK equities, onshore rates, RMB FX, and CN-relevant commodities
- Prefer CN/HK tickers where applicable (e.g., 000300.SS, 399001.SZ, 399006.SZ, 000016.SS, ^HSI)
- If suggesting global commodities (WTI/Brent/iron ore), explicitly tie to CN supply/demand or policy
` : ''}
